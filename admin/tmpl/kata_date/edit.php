...
$walk_id = $app->getUserState('com_katas.walk_id');
...
<form action="<?php echo Route::_('index.php?option=com_katas&view=kata_date&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="mywalk-dates-form" class="form-validate">
	...
	<div>
		...
		<?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'details', Text::_('COM_KATAS_KATA_DATE_TAB_DETAILS')); ?>
		<div class="row">
			<div class="col-md-9">
				<div class="row">
					<div class="col-md-6">
