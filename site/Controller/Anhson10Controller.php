...
class Anhson10Controller extends BaseController

{
	...
	public function FieldsRead()
	{
		...
		->from($db->quoteName('#__anhson10', 'a'))
		...
		$result = $db->insertObject('#__anhson10', $profile);		
	...
	public function FieldsUpdate()
		...
		$profile->field9 =$dulieu->field9;	
		$profile->field10 =$dulieu->field10;
		$result = $db->updateObject('#__anhson10', $profile, 'id');
		...
		public function FieldsRemove()
			...
			$dulieu = $data->dulieu;
				...
				$query->delete($db->quoteName('#__anhson10'));
