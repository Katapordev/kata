...
class ChusauController extends BaseController

{
	...
	public function FieldsRead()
	{
		...
		$result = $db->insertObject('#__chusau', $profile);		
	...
	public function FieldsUpdate()
		...
		$profile->field9 =$dulieu->field9;	
		$profile->field10 =$dulieu->field10;
		$result = $db->updateObject('#__chusau', $profile, 'id');
		...
		public function FieldsRemove()
			...
			$dulieu = $data->dulieu;
				...
				$query->delete($db->quoteName('#__chusau'));
