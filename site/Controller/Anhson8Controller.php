...
class Anhson8Controller extends BaseController

{
	...
	public function FieldsRead()
	{
		...
		$result = $db->insertObject('#__anhson8', $profile);		
	...
	public function FieldsUpdate()
		...
		$profile->field9 =$dulieu->field9;	
		$profile->field10 =$dulieu->field10;
		$result = $db->updateObject('#__anhson8', $profile, 'id');
		...
		public function FieldsRemove()
			...
			$dulieu = $data->dulieu;
				...
				$query->delete($db->quoteName('#__anhson8'));
