...
class Anhson9Controller extends BaseController

{
	...
	public function FieldsRead()
	{
		...
		$result = $db->insertObject('#__anhson9', $profile);		
	...
	public function FieldsUpdate()
		...
		$profile->field9 =$dulieu->field9;	
		$profile->field10 =$dulieu->field10;
		$result = $db->updateObject('#__anhson9', $profile, 'id');
		...
		public function FieldsRemove()
			...
			$dulieu = $data->dulieu;
				...
				$query->delete($db->quoteName('#__anhson9'));
