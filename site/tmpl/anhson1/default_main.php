...
HTMLHelper::_('script','components/com_katas/js/anhson'.$params->get('database').'.js', array('version' =>'auto'),array('defer' => 'true'));
   ...
   <div class="row">
      <div class="col-sm-4 col-12 {{AnHienTaoMoi}}">
		...
		<textarea class="form-control {{mauedit}}" rows="5" placeholder="<?php print_r($params->get('field1')); ?>" ng-model="dulieu.field1">
               ...
               <div class="form-group col-12" ng-if="<?php print_r($params->get('anhien2')); ?>">
				   <fieldset class="border p-2">
               ...
               <div class="form-group col-12" ng-if="<?php print_r($params->get('anhien3')); ?>">
				 	<fieldset class="border p-2">
               ...
               <div class="form-group col-12" ng-if="<?php print_r($params->get('anhien4')); ?>">
			<fieldset class="border p-2">
		...
		<textarea class="form-control {{mauedit}}" rows="5" placeholder="<?php print_r($params->get('field4')); ?>" ng-model="dulieu.field4"> 
               ...
               <div class="form-group col-12" ng-if="<?php print_r($params->get('anhien5')); ?>">
				 			<fieldset class="border p-2">
...
<div class="form-group col-12" ng-if="<?php print_r($params->get('anhien6')); ?>">	
	<fieldset class="border p-2">
               ...
               <div class="form-group col-12" ng-if="<?php print_r($params->get('anhien7')); ?>">
			<fieldset class="border p-2">		   
    ...
    <div class="form-group col-12" ng-if="<?php print_r($params->get('anhien8')); ?>">
			<fieldset class="border p-2">		   
    ...
    <div class="form-group col-12" ng-if="<?php print_r($params->get('anhien9')); ?>">
			<fieldset class="border p-2">		   
         ...
         <div class="table-responsive">
            <table class="table table-bordered" ng-init="FieldsRead()">
               <thead class="thead-dark">
                  <tr>
                     <th>#</th>
					<?php echo $admin==1?'<th>User <input class="form-control" ng-model="search.name" placeholder="User" /></th>':'' ; ?>   
                     
                     <th ng-if="<?php print_r($params->get('anhien1')); ?>"><?php print_r($params->get('field1')); ?><input class="form-control" ng-model="search.field1" placeholder="<?php print_r($params->get('field1')); ?>" /></th>
                     <th ng-if="<?php print_r($params->get('anhien2')); ?>"><?php print_r($params->get('field2')); ?></th>
					 <th ng-if="<?php print_r($params->get('anhien3')); ?>"><?php print_r($params->get('field3')); ?></th>
					 <th ng-if="<?php print_r($params->get('anhien4')); ?>"><?php print_r($params->get('field4')); ?></th> 
					 <th ng-if="<?php print_r($params->get('anhien5')); ?>"><?php print_r($params->get('field5')); ?></th>
					 <th ng-if="<?php print_r($params->get('anhien6')); ?>"><?php print_r($params->get('field6')); ?></th> 
                     <th ng-if="<?php print_r($params->get('anhien7')); ?>"><?php print_r($params->get('field7')); ?></th>
                     <th ng-if="<?php print_r($params->get('anhien8')); ?>"><?php print_r($params->get('field8')); ?></th>
			...
			<?php echo $admin==1?'<td>{{as.name}}</td>':'' ; ?>  		  
                     ...
                     <td ng-if="<?php print_r($params->get('anhien1')); ?>">{{as.field1}}</td>
                     <td ng-if="<?php print_r($params->get('anhien2')); ?>">{{as.field2}}</td>
					 <td ng-if="<?php print_r($params->get('anhien3')); ?>">{{as.field3}}</td> 
					 <td ng-if="<?php print_r($params->get('anhien4')); ?>">{{as.field4}}</td> 
					 <td ng-if="<?php print_r($params->get('anhien5')); ?>">{{as.field5}}</td>   
					<td ng-if="<?php print_r($params->get('anhien6')); ?>">{{as.field6}}</td>  
					<td ng-if="<?php print_r($params->get('anhien7')); ?>">{{as.field7}}</td>  
			       <td ng-if="<?php print_r($params->get('anhien8')); ?>">{{as.field8}}</td>
